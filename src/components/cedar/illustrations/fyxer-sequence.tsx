...
import { DrawnCircle, DrawnFigure, DrawnLabel, DrawnPath, DrawnRect } from "../../field-notes/illustrations/drawn";
 ...
 * terracotta, which is the only place the accent earns its keep on this page.
...
export function FyxerSequence({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <DrawnPath className="text-terracotta" d="M216 100 H258" delay={0.75} duration={0.35} strokeWidth={1.5} />
      <DrawnPath className="text-terracotta" d="M250 94 L258 100 L250 106" delay={1} duration={0.2} strokeWidth={1.5} />
      ...
      <DrawnPath className="text-terracotta" d="M502 100 H544" delay={1.8} duration={0.35} strokeWidth={1.5} />
      <DrawnPath
        className="text-terracotta"
        d="M536 94 L544 100 L536 106"
        delay={2.05}
        duration={0.2}
        strokeWidth={1.5}
      />
      ...
      <DrawnCircle className="text-terracotta" cx={700} cy={52} delay={2.8} r={8} strokeWidth={1.6} />
      <DrawnPath className="text-terracotta" d="M714 44 Q734 32 746 46" delay={3} duration={0.35} strokeWidth={1.4} />
      <DrawnLabel className="fill-terracotta font-display text-[14px] italic" delay={3.25} x={752} y={42}>
        shipping now
      </DrawnLabel>

      <DrawnPath className="text-limestone-shade" d="M12 178 H762" delay={3.35} strokeWidth={1} />
